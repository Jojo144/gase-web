...
<html>
	...
	<div style="text-align: center">
	    ...
	    Le prix TTC doit être indiqué à l'unite ou au kilo.<br /> Le nom du
	    produit est à écrire en minuscule avec une majuscule au debut, en
	    indiquant si possible le poids ou le volume.
	    <div>
		<form id="formulaire" method="post" action="nouvelleReferenceE.php">
		    <div id="table">
			<p class="ligne">
			    <label class="col1" for="designation">Désignation* :</label> <input
...
class="col2" name="fournisseur" id="fournisseur" required>
			...
			<p class="ligne">
			    <label class="col1" for="categorie">Catégorie* :</label> <select
...
type="text" class="col2" name="prix" id="prix" required />
			</p>
			<p class="ligne">
...
type="text" class="col2" name="visible" id="visible">
				<option value="1" selected="selected">OUI</option>
				<option value="0">NON</option>
			    </select>
			</p>
			<p class="ligne">
			    <label class="col1" for="prix">Alerte stock (quantité, kg, litre)
				:</label> <input type="text" class="col2" name="alert_stock"
id="alert_stock" /> <label class="col1" for="alert_stock"><small>laisser
				vide si pas d'alerte</small></label>
			</p>
		    </div>
		    <div id="bouton">
			<p>
