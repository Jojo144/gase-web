...
type="text" class="col2" name="contact" id="contact" />
			</p>
			<p class="ligne">
			    <label class="col1" for="telephoneFixe">Téléphone fixe :</label> <input
type="text" class="col2" name="telephoneFixe" id="telephoneFixe" />
			</p>
			<p class="ligne">
