...
include 'menu.php';
		...
		<div
		style="text-align: center; position: relative; top: -20px; z-index: 0;">
		<form action="stock_stat.php" method="GET">
			<input type="hidden" name="id" value="<?php echo $ref_id; ?>"> <select
		        ...
		        <?php
										...
										?>
		    </select> <strong><?php echo $ref_details["DESIGNATION"]?></strong> (<?php echo $ref_details["NOM_FOURNISSEUR"]?>)
		    </form>
	</div>
		<?php $GET_param = "?id=$ref_id&year=$year_selected";?>
		<img style="display: block; margin-left: auto; margin-right: auto;"
		src="stock_stat_generate.php<?php echo $GET_param; ?>">
</body>
</html>
