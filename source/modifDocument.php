	...
	<div style="text-align: center">
		...
		<div class="liste" style="text-align: left">
			...
			<table>
				...
				<tr>
				    <td><label class="colonne1"><center>
					<strong><?php echo $document['NOM']; ?></strong>
				    </center></label></td>
				    <td><label class="colonne2"><center>
					<strong><?php echo $document['DATE']; ?></strong>
				    </center></label></td>
				    <td><label class="colonne3"><center>
					<strong><?php echo $nomFournisseur; ?></strong>
				    </center></label></td>
				    <td><label class="colonne4"><center>
					<strong><?php echo $document['NET_A_PAYER']; ?></strong>
				    </center></label></td>

				    <td>
					<form method="post" action="telechargerDocument.php"
enctype="multipart/form-data">
					    <input type="hidden" name="nomDocument"
value="<?php echo './archives/-'.$document['ID_DOCUMENT'].'-'.$document['NOM']; ?>" />
			...
			<table>
				...
				<tr>
				    ...
				    <form method="post" action="telechargerDocument.php"
enctype="multipart/form-data">
					<td><input type="hidden" name="nomDocument"
value="<?php echo './archives/-'.$document['ID_DOCUMENT'].'-'.$document['NOM']; ?>" />
					    <input type="submit" name="submit" value="Telecharger" /></td>
				    </form>
				</tr>
			    <?php
			    }
