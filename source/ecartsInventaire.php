...
<html>
	...
	<?php include 'menu.php'; ?>
		...
		<strong>Inventaire du : </strong> <select name="inventaire_date"
onchange="this.form.submit()">
                    <?php
		    
		    foreach ( $inventaire_date_list as $i ) {
		    ...
		    ?>
		</select> - <strong>Total Ecart* : </strong><?php echo round($total_ecart, 2) ?> euro
            </form>
	</div>
...
style="margin-left: auto; margin-right: auto; max-width: 1000px;">
	...
	<div style="text-align: center;">
	    <a
href="ecartsInventaire.php?inventaire_date=<?php echo $inventaire_date_selected ?>&type=csv"
download="ecarts_<?php echo $inventaire_date_selected ?>.csv">
	...
	<div style="text-align: center;">
	    <strong>**</strong>Une valeur négative signifie une perte (un produit
	    disparu)
	</div>
	<br>
    </body>
