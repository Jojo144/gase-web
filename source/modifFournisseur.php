...
value="<?php echo $donnees['NOM']; ?>" autofocus required />
			</p>
			<p class="ligne">
			    <label class="col1" for="mail">Email : </label> <input type="text"
class="col2" size="50" name="mail" id="mail"
value="<?php echo $donnees['MAIL']; ?>" />
			</p>
			<p class="ligne">
			    <label class="col1" for="adresse">Adresse : </label> <input
type="text" class="col2" size="50" name="adresse" id="adresse"
value="<?php echo $donnees['ADRESSE']; ?>" />
			</p>
			<p class="ligne">
			    <label class="col1" for="contact">Nom contact : </label> <input
type="text" class="col2" size="50" name="contact" id="contact"
value="<?php echo $donnees['CONTACT']; ?>" />
			</p>
			<p class="ligne">
			    <label class="col1" for="telephoneFixe">Telephone fixe : </label>
			    <input type="text" class="col2" name="telephoneFixe"
id="telephoneFixe"
value="<?php echo $donnees['TELEPHONE_FIXE']; ?>" />
			</p>
			<p class="ligne">
			    <label class="col1" for="telephonePortable">Telephone portable : </label>
			    <input type="text" class="col2" name="telephonePortable"
id="telephonePortable"
value="<?php echo $donnees['TELEPHONE_PORTABLE']; ?>" />
			</p>
			<p class="ligne">
			    <label class="col1" for="fax">Fax : </label> <input type="text"
class="col2" name="fax" id="fax"
value="<?php echo $donnees['FAX']; ?>" />
			</p>
			<p class="ligne">
